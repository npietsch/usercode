...
analyzeSystematicsMu0bUp          = analyzeSystematicsMu0b.clone()
...
## clones to study remaining met scale uncertainties
analyzeSystematicsMu1bUp          = analyzeSystematicsMu1b.clone()
...
## clones to study remaining met scale uncertainties
analyzeSystematicsMu2bUp          = analyzeSystematicsMu2b.clone()
...
## clones to study remaining met scale uncertainties
analyzeSystematicsMu3bUp          = analyzeSystematicsMu3b.clone()
