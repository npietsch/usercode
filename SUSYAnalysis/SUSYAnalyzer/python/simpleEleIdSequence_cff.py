##
## This file is just a copy of ElectroWeakAnalysis/WENu/python/simpleEleIdSequence_cff.py 1.1
##

import FWCore.ParameterSet.Config as cms

from RecoEgamma.ElectronIdentification.simpleCutBasedElectronIDSpring10_cfi import *
