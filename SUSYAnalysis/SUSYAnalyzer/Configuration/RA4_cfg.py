...
from PhysicsTools.PatAlgos.selectionLayer1.genParticlesSelector_cfi import *
...
## select events with no veto muon
from PhysicsTools.PatAlgos.selectionLayer1.muonCountFilter_cfi import *
process.noVetoMuon = countPatMuons.clone(src = 'vetoMuons',
                                          maxNumber = 0
                                         )
## select events with one veto electron
from PhysicsTools.PatAlgos.selectionLayer1.electronCountFilter_cfi import *
process.oneVetoElectron = countPatElectrons.clone(src = 'vetoElectrons',
                                                 maxNumber = 1
                                                 )
...
## select events with on good MET
...
from PhysicsTools.PatAlgos.selectionLayer1.genParticlesCountFilter_cfi import *
...
process.analyzeSUSYEventJets= analyzeSUSYEvent.clone(met = "patMETs")
process.analyzeSUSYEventtest= analyzeSUSYEvent.clone(met = "patMETs")
process.analyzeSUSYEventMET = analyzeSUSYEvent.clone()
...
process.eventWeight.nevts = 1483404
process.eventWeight.xsec = 165
...
process.RA4MuonSelection = cms.Path(process.patDefaultSequence *
                                    ...
                                    process.analyzeSUSYEventJets *
                                    
                                    process.goodMET *
                                    process.cutMET *
                                    process.analyzeMETKinematics *
                                    process.analyzeSUSYEventMET
                                    )
