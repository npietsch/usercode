...
process.load('SUSYAnalysis.ScanAnalyzer.sms3ParamExtract_cfi')
process.sms3ParamExtract.debug = False

process.load('SUSYAnalysis.ScanAnalyzer.sms3ParamFilter_cfi')
process.sms3ParamFilter.mGluino  = float(MGLUINO)
process.sms3ParamFilter.mLSP     = float(MLSP)
process.sms3ParamFilter.xInt     = XINT
process.sms3ParamFilter.paramSrc = "sms3ParamExtract"
process.sms3ParamFilter.debug    = False
