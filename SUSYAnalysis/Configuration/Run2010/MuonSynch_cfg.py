...
process.analyzeMuonQuality1.src = 'selectedPatMuons'

process.analyzeMuonQuality2 = analyzeMuonQuality.clone()
process.analyzeMuonQuality2.src = 'globalPromptTightMuons'

process.analyzeMuonQuality3 = analyzeMuonQuality.clone()
process.analyzeMuonQuality3.src = 'trackMuons'

process.analyzeMuonQuality4 = analyzeMuonQuality.clone()
process.analyzeMuonQuality4.src = 'ptMuons'

process.analyzeMuonQuality5 = analyzeMuonQuality.clone()
process.analyzeMuonQuality5.src = 'etaMuons'

process.analyzeMuonQuality6 = analyzeMuonQuality.clone()
process.analyzeMuonQuality6.src = 'isolatedMuons'

process.analyzeMuonQuality7 = analyzeMuonQuality.clone()
process.analyzeMuonQuality7.src = 'dBMuons'

process.analyzeMuonQuality8 = analyzeMuonQuality.clone()
process.analyzeMuonQuality8.src = 'validHitsMuons'

process.analyzeMuonQuality9 = analyzeMuonQuality.clone()
process.analyzeMuonQuality9.src = 'matchesMuons'

process.analyzeMuonQuality10 = analyzeMuonQuality.clone()
process.analyzeMuonQuality10.src = 'pixelMuons'

process.analyzeMuonQuality11 = analyzeMuonQuality.clone()
process.analyzeMuonQuality11.src = 'vertexMuons'

process.analyzeMuonQuality12 = analyzeMuonQuality.clone()
process.analyzeMuonQuality12.src = 'goodMuons'

from TopAnalysis.TopAnalyzer.MuonKinematics_cfi import *

process.analyzeMuonKinematics1 = analyzeMuonKinematics.clone()
process.analyzeMuonKinematics1.src = 'selectedPatMuons'

process.analyzeMuonKinematics2 = analyzeMuonKinematics.clone()
process.analyzeMuonKinematics2.src = 'globalPromptTightMuons'

process.analyzeMuonKinematics3 = analyzeMuonKinematics.clone()
process.analyzeMuonKinematics3.src = 'trackMuons'

process.analyzeMuonKinematics4 = analyzeMuonKinematics.clone()
process.analyzeMuonKinematics4.src = 'ptMuons'

process.analyzeMuonKinematics5 = analyzeMuonKinematics.clone()
process.analyzeMuonKinematics5.src = 'etaMuons'

process.analyzeMuonKinematics6 = analyzeMuonKinematics.clone()
process.analyzeMuonKinematics6.src = 'isolatedMuons'

process.analyzeMuonKinematics7 = analyzeMuonKinematics.clone()
process.analyzeMuonKinematics7.src = 'dBMuons'

process.analyzeMuonKinematics8 = analyzeMuonKinematics.clone()
process.analyzeMuonKinematics8.src = 'validHitsMuons'

process.analyzeMuonKinematics9 = analyzeMuonKinematics.clone()
process.analyzeMuonKinematics9.src = 'matchesMuons'

process.analyzeMuonKinematics10 = analyzeMuonKinematics.clone()
process.analyzeMuonKinematics10.src = 'pixelMuons'

process.analyzeMuonKinematics11 = analyzeMuonKinematics.clone()
process.analyzeMuonKinematics11.src = 'vertexMuons'

process.analyzeMuonKinematics12 = analyzeMuonKinematics.clone()
process.analyzeMuonKinematics12.src = 'goodMuons'
...
process.Selection1l = cms.Path(process.patDefaultSequence *
                               ...
                               process.analyzeMuonKinematics1 *
                               process.oneGlobalPromptTightMuon *
                               process.analyzeMuonQuality2 *
                               process.analyzeMuonKinematics2 *
                               process.oneTrackMuon *
                               process.analyzeMuonQuality3 *
                               process.analyzeMuonKinematics3 *
                               process.onePtMuon *
                               process.analyzeMuonQuality4 *
                               process.analyzeMuonKinematics4 *
                               process.oneEtaMuon *
                               process.analyzeMuonQuality5 *
                               process.analyzeMuonKinematics5 *
                               process.oneIsolatedMuon *
                               process.analyzeMuonQuality6 *
                               process.analyzeMuonKinematics6 *
                               process.oneDBMuon *
                               process.analyzeMuonQuality7 *
                               process.analyzeMuonKinematics7 *
                               process.oneValidHitMuon *
                               process.analyzeMuonQuality8 *
                               process.analyzeMuonKinematics8 *
                               process.oneMatchesMuon *
                               process.analyzeMuonQuality9 *
                               process.analyzeMuonKinematics9 *
                               process.onePixelMuon *
                               process.analyzeMuonQuality10 *
                               process.analyzeMuonKinematics10 *
                               process.oneVertexMuon *
                               process.analyzeMuonQuality11 *
                               process.analyzeMuonKinematics11 *
                               process.oneGoodMuon *
                               process.analyzeMuonQuality12 *
                               process.analyzeMuonKinematics12 
                               )
