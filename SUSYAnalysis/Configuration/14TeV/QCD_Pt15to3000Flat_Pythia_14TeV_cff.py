...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('\$Source: /afs/cern.ch/project/cvs/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/QCD_Pt_15to3000_TuneZ2_Flat_8TeV_pythia6_cff.py,v $'),
