...
#include "SUSYAnalysis/SUSYEventProducers/interface/HerwigGenEventJetsProducer.h"
...
HerwigGenEventJetsProducer::HerwigGenEventJetsProducer(const edm::ParameterSet& cfg):
...
void
HerwigGenEventJetsProducer::beginJob()
{	
}

void
HerwigGenEventJetsProducer::produce(edm::Event& event, const edm::EventSetup& setup)
{
  // handles
...
DEFINE_FWK_MODULE(HerwigGenEventJetsProducer);
