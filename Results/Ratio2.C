...
int Ratio2()
{
  ...
  //MCElSelections.push_back("analyzeBtagsElElSSVHEM3highPtdilep");
  //MCElElSelections.push_back("analyzeBtagsElElSSVHEM3highPtdilep");

  //DataMuSelections.push_back("analyzeBtagsMuSSVHEM3highPtdilep");
  //DataElSelections.push_back("analyzeBtagsElElSSVHEM3highPtdilep");
  ...
  MCElElSelections.push_back("analyzeBtagsElElSSVHEM3lowPtdilep");

  DataMuSelections.push_back("analyzeBtagsMuSSVHEM3lowPtdilep");
  DataElSelections.push_back("analyzeBtagsElSSVHEM3lowPtdilep");
  DataElElSelections.push_back("analyzeBtagsElElSSVHEM3lowPtdilep");
  ...
  for(int sel=0; sel<(int)MCMuSelections.size(); ++sel)
      ...
      for(int ibin=0; ibin<=20; ++ibin)
	{
      ...
      MuCanvas->SaveAs(MCMuSelections[sel]+"_Ratio2.pdf");
    }
  ...
  for(int sel=0; sel<(int)MCElSelections.size(); ++sel)
      ...
      for(int ibin=0; ibin<=20; ++ibin)
	{
      ...
      ElCanvas->SaveAs(MCElSelections[sel]+"_Ratio2.pdf");
    }
...
//       MuElCanvas->SaveAs(MCMuSelections[sel]+"_RatioMuEl2.pdf");
//     }
