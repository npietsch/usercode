...
process = cms.Process("BtagSystematics") 
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string('BtagSystematics.root')
                                   )
...
process.btagEventWeightMuTCHEM3.scaleEventMistagSF = True
...
process.btagEventWeightElTCHEM3.scaleEventMistagSF = True

#----------------------------------------------------------------------------------------
# Load and configure modules for analysis of b-tagging in muon channel
#----------------------------------------------------------------------------------------

from Btagging.BtagAnalyzer.BtagSystematicsAnalyzer_cfi import *

process.analyzeBtagSystematics = analyzeBtagSystematics.clone()
process.analyzeBtagSystematics.useEventWeight = True
process.analyzeBtagSystematics.useBtagEventWeight = True

process.analyzeBtagSystematicsMuTCHEM3 = process.analyzeBtagSystematics.clone()
process.analyzeBtagSystematicsMuTCHEM3.bjets                  = "mediumTrackHighEffBjets"
process.analyzeBtagSystematicsMuTCHEM3.BtagJetWeights         = "btagEventWeightMuTCHEM3:RA4bSFJetWeights"
process.analyzeBtagSystematicsMuTCHEM3.BtagEventWeights       = "btagEventWeightMuTCHEM3:RA4bSFEventWeights"
process.analyzeBtagSystematicsMuTCHEM3.BtagJetWeightsGrid     = "btagEventWeightMuTCHEM3:RA4bJetWeightsGrid"
process.analyzeBtagSystematicsMuTCHEM3.BtagEventWeightsGrid   = "btagEventWeightMuTCHEM3:RA4bEventWeightsGrid"
process.analyzeBtagSystematicsMuTCHEM3.MistagEventWeightsGrid = "btagEventWeightMuTCHEM3:RA4bEventWeightsGridMistag"
process.analyzeBtagSystematicsMuTCHEM3.jets                   = "goodJets"

process.analyzeBtagSystematicsElTCHEM3 = process.analyzeBtagSystematics.clone()
process.analyzeBtagSystematicsElTCHEM3.bjets                  = "mediumTrackHighEffBjets"
process.analyzeBtagSystematicsElTCHEM3.BtagJetWeights         = "btagEventWeightElTCHEM3:RA4bSFJetWeights"
process.analyzeBtagSystematicsElTCHEM3.BtagEventWeights       = "btagEventWeightElTCHEM3:RA4bSFEventWeights"
process.analyzeBtagSystematicsElTCHEM3.BtagJetWeightsGrid     = "btagEventWeightElTCHEM3:RA4bJetWeightsGrid"
process.analyzeBtagSystematicsElTCHEM3.BtagEventWeightsGrid   = "btagEventWeightElTCHEM3:RA4bEventWeightsGrid"
process.analyzeBtagSystematicsElTCHEM3.MistagEventWeightsGrid = "btagEventWeightElTCHEM3:RA4bEventWeightsGridMistag"
process.analyzeBtagSystematicsElTCHEM3.jets                   = "goodJets"

#--------------------------
# Muon selection path
#--------------------------

process.analyzeBtagSystematics_Mu = cms.Path(process.preselectionMuHTMC2 *
                                             ...
                                             process.analyzeBtagSystematicsMuTCHEM3
                                             )
#--------------------------
# Electron selection path
#--------------------------

process.analyzeBtagSystematics_El = cms.Path(process.preselectionElHTMC2 *
                                             process.eventWeightPU *
                                             process.weightProducer *
                                             process.makeObjects *
                                             ...
                                             process.jetSelection*
                                             process.analyzeBtagSystematicsElTCHEM3
                                             )
